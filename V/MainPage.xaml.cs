...
public partial class MainPage : ContentPage
{
	public MainPage()
	{
		...
		// We don't want to show the user any messages generated by loading the journal file - these
		// are old news.
        if(MainViewModel.Instance.UserMessages!=null)
            MainViewModel.Instance.UserMessages.Clear();
