...
namespace LobsterConnect.V
{
    public class ComboBox : StackLayout
    {
        ...
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource), typeof(IList), typeof(ComboBox), defaultValue: null, propertyChanged: (bindable, oldVal, newVal) => {
            var comboBox = (ComboBox)bindable;
            comboBox._listView.ItemsSource = (IList)newVal;
        });
        ...
        */
        ...
        public ComboBox()
        {
            ...
            _listView.HorizontalOptions = LayoutOptions.Start;
