...
//   which does at leasr mean that text is always shown in black on the 'session' rectangles.
// - Look into what happens when a new gaming event is added via sync from internet; it seems that the
//   list of available games in the dropdown is not getting refreshed accordingly, until you
//   do 'reset app'.
